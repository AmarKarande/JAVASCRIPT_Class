...
// A student has to attend an exam at a particular time (for example at 9:30 am). They arrive in the exam room at a particular
//  time of arrival (for example 9:40 am). It is considered that the student has arrived on time, if they have arrived at
// the time when the exam starts or up to half an hour earlier. If the student has arrived more than 30 minutes earlier,
// the student has come too early. If they have arrived after the time when the exam starts, they are late.
...
let studentArrival = { hrs: 9, mins: 21 };

if (studentArrival.hrs >= examstartTime.hrs) {
  if (studentArrival.mins > examstartTime.mins) {
    console.log("Late!");
  }
}
